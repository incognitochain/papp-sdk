class Validator {
  ...
  _throwError(message) {
    throw new Error(`Validating "${this.label}" failed: ${message}. Found ${JSON.stringify(this.value)} (type of ${typeof this.value})`);  
  }
  ...
  object(message = 'Must be an object') {
    return this._onCondition(() => typeof this.value === 'object' && this.value !== null, message);
  }
  ...
  intergerNumber(message = 'Must be a valid interger number and larger than 0') {
